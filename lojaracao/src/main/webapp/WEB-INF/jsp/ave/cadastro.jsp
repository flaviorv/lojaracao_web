	...
	<div class="container">
		<form action="/ave/incluir" method="post">
			...
			<div class="form-group">
				...
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="tipo" value="<%=Constantes.TIPO1%>" class="form-check-input"
						checked> <%=Constantes.TIPO1%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="tipo" value="<%=Constantes.TIPO2%>" class="form-check-input">
						<%=Constantes.TIPO2%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="tipo" value="<%=Constantes.TIPO3%>" class="form-check-input">
						<%=Constantes.TIPO3%>
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="aroma" value="<%=Constantes.AROMA1%>"
						class="form-check-input" checked> <%=Constantes.AROMA1%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="aroma" value="<%=Constantes.AROMA2%>"
						class="form-check-input"> <%=Constantes.AROMA2%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="aroma" value="<%=Constantes.AROMA3%>"
						class="form-check-input"> <%=Constantes.AROMA3%>
					</label>
				</div>
			</div>
