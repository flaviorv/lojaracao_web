	...
	<div class="container">
		<form action="/gato/incluir" method="post">
			...
			<div class="form-group">
				...
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="castrado" value="true" class="form-check-input">Sim
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="castrado" value="false" class="form-check-input" checked>Não
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="sabor" value="<%=Constantes.SABOR1%>"
						class="form-check-input" checked> <%=Constantes.SABOR1%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="sabor" value="<%=Constantes.SABOR2%>"
						class="form-check-input"> <%=Constantes.SABOR2%>
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label"> <input type="radio"
						name="sabor" value="<%=Constantes.SABOR3%>"
						class="form-check-input"> <%=Constantes.SABOR3%>
					</label>
				</div>
			</div>
			<div class="form-group">
